...
from bot import DOWNLOAD_DIR, dispatcher, BOT_PM, LOGGER, CMD_INDEX
...
def _watch(bot, message, isZip=False, isLeech=False, multi=0):
    ...
    if not is_url(link):
        help_msg = F"<b>/watch Commands are Specifically for Youtube. Still Confused? Why don't you try /help{CMD_INDEX}</b>"
